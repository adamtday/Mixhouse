...
retrieval_tags: [audience, positioning, segments, viewers, talent, sponsors]
related:
...
- MixHouse serves six primary audiences, not one. Mixing their messages dilutes all of them.
- Each audience has a single "must believe" claim and a single "must do" action.
- The website's progressive-disclosure model maps directly to these audiences (see `08_website_strategy/progressive_disclosure_model.md`).
- Talent is an audience, not a resource. Casting succeeds when producer/DJ communities pull the show, not the other way around.

## Core Content

### The Six Primary Audiences
...
#### Streamer / Broadcaster Buyer

- **Profile:** Commissioning execs at streamers (Netflix, Amazon, Apple, Max, Prime Video) and major broadcasters (BBC, Channel 4, ITVX, Sky, ProSieben, France TV, etc.).
- **Pains:** Format fatigue; cost discipline; demo pressure (younger viewers); need a defensible IP, not a one-off.
- **What we provide:** Franchisable format, recognisable territory adaptations, prestige cinematography, captive Gen Z/Millennial demo.
- **Key proof points:** Casting pipeline, music release pipeline, pilot cinematography reel, advisor list, comp set differentiation.

#### Investor / Financier

- **Profile:** Format equity investors, slate financiers, music-tech crossover funds, family offices with media exposure.
- **Pains:** Single-format risk; over-reliance on licence fees; talent-led franchises with no IP.
- **What we provide:** Multi-format revenue stack across linear, music, live, sponsorship, IP licensing.
- **Key proof points:** `05_business_model/franchise_flywheel.md`, `05_business_model/investor_case.md`.
...
#### Advisor / Industry Validator

- **Profile:** Label A&R, festival promoters, agency partners, electronic-music journalists, established artists.
- **Pains:** Risk of being attached to a format that disrespects the scene.
...
- Each audience corresponds to either a page, a section, or a gated material in `08_website_strategy/page_briefs/`.
- `materials.md`, `advisors.md`, `business_model.md` exist primarily for the investor / broadcaster / sponsor stack.
- `home.md` and `the_show.md` serve viewer / fan primarily, with secondary signal to advisor and talent.

## Open Questions

- Sizing each audience: how many of each must convert, and at what rate, before the format greenlights? Owner: `05_business_model/investor_case.md`.
- Should there be a seventh audience for press / scene journalists? Likely a sub-segment of "audience" but with distinct messaging during launch.
