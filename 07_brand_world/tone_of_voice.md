...
retrieval_tags: [brand_voice, tone_of_voice, anti_patterns]
related:
...
- Not hype-driven.
- Not motivational ("chase your dreams").
- Not breathless ("get ready for…").
- Not generic-startup ("we believe…", "we're on a mission to…").
...
>
> "We're on a mission to revolutionise how the world experiences electronic music."
>
> "At the intersection of music, reality, and culture, MixHouse delivers an unforgettable journey."

### Pronoun Posture

- Default: third person about the show; second person about the audience; first person plural sparingly.
- Avoid "we" except where it carries real first-person ownership (e.g. "We pick the room…").
- Talent is referred to by name, not by "contestants" in public-facing copy unless context demands.
...
| --- | --- |
| **Investor / broadcaster** | More precise; reference numbers earlier; minimal poetic flourish. |
| **Talent / scene** | Insider vocabulary native; respect for craft; talk about gear, rooms, releases. |
| **Audience / fan** | Lead with cinematic atmosphere; explain only what aids welcome. |
| **Press / EPK** | Editorial; story-led; embargoed facts; no marketing varnish. |
...
When voice meets motion (trailers, social):
- Music is louder than voice; voiceover is sparing or absent.
- On-screen type is restrained.
- Cinematic restraint applies to language too.
...
| Objection | Response |
| --- | --- |
| "Quiet voice won't break through in social." | Quiet voice is differentiated *because* the feed is loud. The signal is the gap. |
| "Investors expect hype language." | Investors expect rigour. Hype gets discounted. |
