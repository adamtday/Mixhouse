...
retrieval_tags: [reality_tv, market_size, competitive, why_now, audience_behaviour]
related:
...
- The unscripted market has bifurcated: legacy competition formats (declining) vs prestige cinematic unscripted (growing).
- Music-led formats are conspicuously absent from the prestige tier.
- Streamers are willing to pay docu-level CPHs for prestige unscripted that builds franchise-able IP.
- 18–34 demos are the under-served bullseye for streamers, exactly where electronic-music audiences over-index.
- All quantitative claims below are placeholders pending A/B-tier sourcing.

## Core Content

### Market Structure

| Tier | Examples | Typical home | Trend |
| --- | --- | --- | --- |
| **Legacy competition** | The Voice, Idol, X Factor (international) | Broadcast networks | Declining ratings; format saturation. |
| **Reality dating / lifestyle** | Love Island, Selling Sunset, Below Deck | Broadcast + streamers | Stable for franchise leaders; pressure on imitators. |
...
Patterns the prestige tier shares:

1. Cinematic crews, scripted-grade DPs.
2. Character-led storytelling over format-mechanic-led.
3. Real-world stakes (sport, performance, business).
4. Strong IP travel (international format adaptations and follow-ups).
5. Sound design and music supervision at scripted level.

MixHouse satisfies every pattern.
...
The 18–34 demo is over-represented in:
- Electronic-music listening and live attendance.
...
- Streamer commissioning budgets are under pressure post-2023.
- New entrants (FAST channels, AVOD) compete for unscripted IP.
- Long-tail catalogues are eating new-commission share in some markets.

These risks reinforce, not undermine, the franchise case: durable IP outlasts commissioning cycles.
...
- "Where MixHouse sits" component on `business_model.md` references the four-tier table.
- Broadcaster decks open with this landscape framing.

## Open Questions

- Quantify prestige unscripted slot count vs music-led commissioning over the past 36 months.
- Identify named commissioners actively chasing the slot shape we describe.
