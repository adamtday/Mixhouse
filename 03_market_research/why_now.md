...
retrieval_tags: [why_now, market_size, audience_behaviour, positioning]
related:
...
- Four conditions converge: peak festival economy, producer-as-celebrity, format fatigue in legacy reality, and short-form discovery amplifying music releases.
- None of these conditions held simultaneously in 2010 or 2015. They likely won't hold uncontested past 2028.
- "Why now" is the most common gating question in commissioning and investor meetings. Owning it cleanly accelerates every other conversation.
...
- Implication: a flagship show that culminates in a real festival headline slot is *legible* to audiences in a way it wasn't a decade ago.
...
- Implication: a show that releases real music each week *and* clips well to short-form is positioned to convert viewership into streaming behaviour at scale.

### Why Not Earlier?

| Year | Missing condition |
| --- | --- |
| 2010 | Streaming economics didn't reward in-show music releases; producers weren't recognisable celebrities. |
| 2015 | Festival economy was rising but TikTok-style discovery didn't exist yet. |
| 2020 | COVID erased the live-event payoff at the heart of the format. |

### Why Not Later?

- Legacy reality slots are actively being reallocated. The "open slot" closes when someone else takes it.
- Producer-as-celebrity momentum has a finite curve; we want to ride it while it's growing, not after saturation.
- Short-form audio licensing is tightening; act now while licensing partnerships are still negotiable on favourable terms.

### Signals an Investor Will Accept

1. Festival sell-out velocity year-on-year.
2. IFPI / RIAA streaming share of electronic genres.
3. Producer-as-celebrity touring economics (Pollstar / Billboard Boxscore).
4. Streamer commissioning patterns for prestige unscripted (Parrot Analytics).
5. TikTok-driven streaming uplift case studies (Chartmetric, Luminate).

Each signal becomes a row in the Evidence / Sources table once populated.
...
- Who owns sourcing IFPI / RIAA / Luminate access? (Likely an analyst engagement or partnership.)
- Are there longitudinal datasets that show producer-as-celebrity curve quantitatively, not just anecdotally?
